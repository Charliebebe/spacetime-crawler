...
from datamodel.search.Charlit1GiremadzAguarda2_datamodel import Charlit1GiremadzAguarda2ProjectionLink
...
@Deleter(Charlit1GiremadzAguarda2ProjectionLink)
@Getter(Charlit1GiremadzAguarda2ProjectionLink)
class DeleteFrontierFrame(IApplication):
    ...
    def update(self):
        ...
        ls = self.frame.get(Charlit1GiremadzAguarda2ProjectionLink)
        print "Found ", len(ls), " links to delete."
        for l in ls:
            self.frame.delete(Charlit1GiremadzAguarda2ProjectionLink, l)
